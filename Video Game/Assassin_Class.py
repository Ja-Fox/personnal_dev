...
class Assassin:
    ...
    def __init__(self,player_name,attributes,starting_health = 22):
        self.player_name = player_name
        self.attributes = attributes
        self.starting_health = starting_health

        self.spells = ['Eviscerate','Backstab','Fan of Knives']
        text = f"As an Assassin, you have access to the following abilities:"
        ...
        for character in text2:
            ...
            time.sleep(.05)
        print('\n') 
        text3 = f"You wield a novice-level dagger.\n"
        for character in text3:
            if character == ' ':
                time.sleep(.05)
            print (character,end='',flush=True)
            time.sleep(.05)
        self.weapon = Weapon_Classes.Dirk("Stillness",1)
...
{self.weapon.abilities[2]}""")
    ...
    def ability_descriptions(self):
        print(f""" 
Eviscerate - Strike with precision at your enemy's weak spot
Backstab - Leap into the air, vaulting over your enemy, and strike them from behind
Fan of Knives - Throw a flurry of knives at your target
""")
