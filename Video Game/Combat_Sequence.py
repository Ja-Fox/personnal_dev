...
def flee_easy_combat(player_character):
...
def easy_combat(player_health, player_character, potion_inventory, item_inventory):
    ...
    if answer == 'flee':
        success = flee_easy_combat(player_character)
        if success == 'yes':
            print ('You escape!')
...
def boss_combat(player_health, player_character, potion_inventory, item_inventory, boss, boss_health):
    boss_entrance = f"You see the {boss} for the first time. There is fleeing this encounter..."
