...
class Paladin:
    ...
    def __init__(self,player_name,attributes,starting_health = 25):
        self.player_name = player_name
        self.attributes = attributes
        self.starting_health = starting_health

        self.spells = ['Smite','Banish','Rebuke']      
        text = f"As a Paladin, you have the follwing spells in your aresenal:"
...
This will serve you well in close combat."""
        for character in text2:
            ...
            time.sleep(.05)
        print('\n')
        text3 = f"You wield a novice-level mace.\n"
        for character in text3:
            if character == ' ':
                time.sleep(.05)
            print (character,end='',flush=True)
            time.sleep(.05)
        self.weapon = Weapon_Classes.Mallet("Concecrated Mallet",1)
...
{self.weapon.abilities[2]}""")
    ...
    def ability_descriptions(self):
        print(f"""
Smite - Bring down the wrath of the heavens on your target
Banish - Seal you target's fate, striking at its soul
Rebuke - Zap your target with heavenly fire
""")
